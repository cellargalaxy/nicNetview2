 ...
 */
@WebFilter(filterName = "monitorAdminFilter", urlPatterns = NetviewAdminControlor.MONITOR_ADMIN_CONTROLOR_URL + "/*")
public class NetviewAdminFilter implements Filter {
	@Autowired
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
		...
		if (!netviewService.checkMonitorAdmin(loginPerson) ) {
			JSONObject jsonObject = new JSONObject();
			jsonObject.put("result", false);
